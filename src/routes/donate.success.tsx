...
function DonationSuccessPage() {
  ...
  const handleDownloadReceipt = async () => {
    ...
    try {
      ...
      doc.save(`EMWA-Donation-Receipt-${result.txRef || tx_ref || "Confirmation"}.pdf`);
  ...
  return (
    <PageShell>
      <section className="py-16 md:py-24 bg-gradient-to-b from-primary/5 via-background to-background min-h-[80vh] flex items-center">
